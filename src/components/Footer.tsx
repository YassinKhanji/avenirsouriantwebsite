      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <a href="https://maps.google.com/?q=1325+Rue+Cartier,+Saint-Laurent,+QC+H4L+2N6" target="_blank" rel="noopener noreferrer" className="text-primary-light hover:text-white underline text-sm mb-6 inline-block">
              View on Google Maps
            </a>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 font-heading">
              ...
              <TransitionLink href="/register" className="hover:text-primary-light transition-colors">Register Now</TransitionLink>
            </div>
          </div>
        </div>
