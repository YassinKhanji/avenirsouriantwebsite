                ...
                <div className="sticky top-8 space-y-8">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 mt-6 pt-5 border-t border-gray-300">
                      ...
                      <a href="https://www.tiktok.com/@avenirsouriant" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-10 h-10 rounded-full bg-gray-50 border border-gray-300 flex items-center justify-center text-gray-500 hover:bg-primary hover:text-white hover:border-primary transition-all duration-300">
